...
//		 																			//
//		 																			//
// Author: 	Mathieu Lattes (mathieu dot lattes at yahoo do fr)						//
//																					//
//		 																			//
...
//***********************************************************************//
//! Print CRS to console (from gdalinfo_lib.cpp)
//***********************************************************************//
void printCRS(GDALDatasetH hDataset, bool bJson, bool bReportProj4)
	{
...
/*
	::CPLprintf("mv \"");
	::CPLprintf(pszSourceName);
	::CPLprintf("\" \"");
	::CPLprintf(pszNewName);
	::CPLprintf("\"\n");*/
	}
